"""CSV export service for saving scraped data."""
...
class CSVExportService:
    """Service for exporting scraped data to CSV files."""
    ...
    def export_news_articles(self, articles: List[NewsArticle], company_name: str) -> str:
        """Export news articles to CSV file."""
        if not articles:
    ...
    def export_website_updates(self, updates: List[WebsiteUpdate], company_name: str) -> str:
        """Export website updates to CSV file."""
        if not updates:
    ...
    def export_business_registry(self, registry_entries: List[BusinessRegistry], company_name: str) -> str:
        """Export business registry entries to CSV file."""
    ...
    def export_comprehensive_data(self, 
        ...
        """Export all scraped data to separate CSV files."""
        exported_files = {}
    ...
    def get_export_summary(self, company_name: str) -> Dict[str, Any]:
        """Get summary of exported files for a company."""
        company_files = []
        
        try:
            # Look for files matching the company name pattern
