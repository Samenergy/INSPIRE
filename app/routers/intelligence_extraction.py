"""Intelligence Extraction Router for Company Profile Analysis.

This router provides endpoints for extracting company intelligence and creating
comprehensive company profiles from multiple articles.
"""
...
async def extract_intelligence_from_csv(
    ...
    """
    Extract company intelligence from articles in CSV file.
    
    This endpoint processes each article individually and returns extracted intelligence.
    For aggregated company profiles, use /company-profile instead.
    """
    try:
...
async def generate_company_profile(
    ...
    """
    Generate comprehensive company profile from multiple articles.
    
    This is the main endpoint you want - it creates the MTN Rwanda-style profile!
    """
    try:
...
async def scrape_and_generate_profile(
    ...
    """
    Scrape company data and generate comprehensive profile in one request.
    
    This is the ultimate endpoint - does everything end-to-end!
    """
    try:
        ...
        # Step 2: Convert to article format
        articles = []
...
async def get_model_info():
    """
    Get intelligence extraction model information.
