    ...
    >
      ...
      <motion.div variants={itemVariants}>
        ...
        >
          <Tab 
            label="All Types" 
            icon={<CampaignIcon size={18} color={tabValue === 0 ? (mode === 'dark' ? '#ffffff' : '#000000') : '#888888'} />} 
            iconPosition="start"
          />
          <Tab 
            label="Email" 
            icon={<EmailIcon size={18} color={tabValue === 1 ? '#3498db' : '#888888'} />} 
            iconPosition="start"
          />
          <Tab 
            label="Call" 
            icon={<PhoneIcon size={18} color={tabValue === 2 ? '#2ecc71' : '#888888'} />} 
            iconPosition="start"
          />
          <Tab 
            label="Meeting" 
            icon={<VideocamIcon size={18} color={tabValue === 3 ? '#f39c12' : '#888888'} />} 
            iconPosition="start"
          />
        </Tabs>
      </motion.div>
      ...
      <InboxContainer variants={containerVariants}>
        {/* List of campaigns */}
        <ListContainer variants={containerVariants}>
                      ...
                      <Box sx={{ width: '100%' }}>
                        <Box sx={{ display: 'flex', justifyContent: 'space-between', mb: 0.5 }}>
                          ...
                          <Box sx={{ display: 'flex', alignItems: 'center' }}>
                            ...
                            >
                              <MoreVertIcon size={16} color={mode === 'dark' ? '#aaaaaa' : '#666666'} />
                            </IconButton>
                          </Box>
                        </Box>
                          ...
                          <Box sx={{ display: 'flex', alignItems: 'center' }}>
                            <Tooltip title={`${campaign.engagement}% engagement rate`}>
                              <Box sx={{ display: 'flex', alignItems: 'center', mr: 1 }}>
                                <TrendingUpIcon size={14} color="#2ecc71" />
        ...
        <DetailContainer variants={containerVariants}>
          {selectedCampaign ? (
            <>
...
export default AnimatedDocuments;